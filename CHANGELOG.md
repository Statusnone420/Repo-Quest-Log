...
- VSIX packaging: `npm run pack:vscode` now emits `release/repo-quest-log-0.0.2.vsix` alongside the Windows release flow.
- Ship/shareability polish: install docs, version bump to `0.0.2`, and first-run empty-state parity coverage.
